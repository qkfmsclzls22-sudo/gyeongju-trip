        ...
        <div className="mb-3 w-[min(90vw,380px)] h-[min(75vh,560px)] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden">
          <div className="bg-amber-500 text-white px-4 py-3 flex items-center justify-between flex-shrink-0">
            <div>
              ...
              <p className="text-amber-100 text-xs">경주 여행 AI 도우미</p>
            </div>
          ...
          {stage === "form" ? (
            <form onSubmit={handleSubmitForm} className="flex-1 overflow-y-auto px-4 py-4 space-y-4 bg-gray-50">
              ...
              <button
                ...
                className="w-full bg-amber-500 hover:bg-amber-600 disabled:opacity-40 text-white font-semibold py-2.5 rounded-xl text-sm transition-colors"
              >
                맞춤 여행정보 받기
              </button>
              <button
